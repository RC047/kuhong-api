...
async function encryptHtml(html, message) {
...
async function encryptScript(script) {
...
`
var data = toBase64(`eval(atob('${toBase64(source.trim())}'));`)
var result = await obfuscate(`eval(atob('${data}'));`, { target: 'browser', preset: 'medium', minify: true, stringEncoding: true });
