...
else if (/(?<=\S+)\.(mp3|m4a|aac|wav|ogg)/gi.test(name)) media = unescape('%%3Caudio%20controls%20style%3D%22width%3A30px%3Bheight%3A75px%3B%22%20src%3D%22') + url + unescape('%22%3E%3C/audio%3E');
