...
try {
if (!path.isAbsolute(targetPath)) throw 'Error: path must be absolute or specify root to auto move file'
var ranName = randomText()
...
function encryptScript(targetPath) {

if (!path.isAbsolute(targetPath)) throw 'Error: path must be absolute or specify root to encrypt a script'
var data = fs.readFileSync(targetPath).toString()
