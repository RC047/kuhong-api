...
var superr = await escapeFull(`eval(unescape('${escapeFull(extended)}'));`)

var data
if (mode == undefined) data = normal // Use for default security
...
if (mode == 'super') data = superr // Security Level (25)
