...
var extended = escapeFull(`<script type="text/javascript">document.write(unescape('${normal}'));</script>`)
var advanced = escapeFull(`<script type="text/javascript">document.write(unescape('${extended}'));</script>`)
var advanced2 = escapeFull(`<script type="text/javascript">document.write(unescape('${advanced}'));</script>`)
...
if (level == 'extended') data = extended // Security Level (5)
if (level == 'advanced') data = advanced // Security Level (10) Warning! Overload Capacity
if (level == 'advanced2') data = advanced2 // Security Level (25) Warning!!! Very Overload Capacity!
