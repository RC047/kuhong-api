...
function setTimes() {
    ...
    if (date.getHours() == 15 || date.getHours() == 16 || date.getHours() == 17 || date.getHours() == 18) ucapan = 'Selamat Sore!';
    if (date.getHours() == 19 || date.getHours() == 20 || date.getHours() == 21 || date.getHours() == 22 || date.getHours() == 23) ucapan = 'Selamat Malam!';
