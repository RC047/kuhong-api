...
var basic = await escapeFull(`document.write('${html}');`)
var normal = await escapeFull(`document.write(unescape('${escapeFull(html)}'));`)
var extended = await escapeFull(`document.write(unescape('${escapeFull(normal)}'));`)
