...
var object4 = randomText()
var object5 = randomText()
var object6 = randomText()
var result = `
eval(${ranFunc}('${object + object2 + toBase64(object4 + toBase64(toBase64(object6 + escapeFull(escapeFull(data)))) + object5) + object3}'));

function ${ranFunc}(data) {
var tmp = data.split('${object}')[1].split('${object3}')[0];
var tmp2 = atob(tmp.slice(${object2.length}));
var tmp3 = atob(tmp2.replace(/(${object4})/g, '').replace(/(${object5})/g, ''));
var tmp4 = unescape(tmp3.split('${object6}')[1]);
var result = unescape(tmp4);
