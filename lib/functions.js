...
const confuse = require('js-confuser')
...
async function encryptScript(data) {
var result = await confuse.obfuscate(data, { target: 'node', preset: 'high', stringEncoding: false });
  return result;
}
...
document.write(${ranFunc}('${object + toBase64(toBase64(html)) + object2}'));
</script>
`
