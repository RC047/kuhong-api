...
const saveToMedia = async (buffer) => {
 ...
 try {
  ...
  var result = `https://kuhong-api.herokuapp.com/media/${ranName}.${ext}`
  await fs.writeFileSync(savePath, buffer).catch((e) => { result = e })
...
var len = 10
var arr = 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'
var random = '';
for (var i = len; i > 0; i--) {
