...
function encryptHtml(html, level, message) {

try {
var basic = escapeFull(html)
var normal = escapeFull(`<script type="text/javascript">document.write(unescape('${basic}'));</script>`)
var double = escapeFull(`<script type="text/javascript">document.write(unescape('${normal}'));</script>`)
var extended = escapeFull(`<script type="text/javascript">document.write(unescape('${double}'));</script>`)
var advanced = escapeFull(`<script type="text/javascript">document.write(unescape('${extended}'));</script>`)

var data
if (level == undefined) data = basic // Use for default security
if (level == 'basic') data = basic // Security Level (1)
if (level == 'normal') data = normal // Security Level (3)
if (level == 'double') data = double // Security Level (5)
if (level == 'extended') data = extended // Security Level (10) Warning! Overload Capacity
if (level == 'advanced') data = advanced // Security Level (25) Warning!!! Very Overload Capacity!
...
`
  ...
  return result.trim()
    ...
    console.log('Failed to Encrypt Html :\n' + e)
  }
}
