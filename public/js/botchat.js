...
var ext = input.name.slice(input.name.length - 3).toLowerCase();
    ...
    else if (/mp3|m4a|aac|wav|ogg/i.test(ext)) media = unescape('%%3Caudio%20controls%20style%3D%22width%3A30px%3Bheight%3A75px%3B%22%20src%3D%22') + fr.result + unescape('%22%3E%3C/audio%3E');
