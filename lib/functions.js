...
var data = escapeFull("document.write(unescape(`" + html + "`))")
var result = `<script type="text/javascript">
<!--
eval(unescape('${data}'));
// -->
</script>`
if (message !== undefined) result = `<script type="text/javascript">
<!-- ${message} -->
<!--
eval(unescape('${data}'));
// -->
...
function fullEncryptHtml(html, message) {

var data = escapeFull("document.write(unescape(`" + escapeFull(html) + "`))")
var result = `<script type="text/javascript">
<!--
eval(unescape('${data}'));
// -->
...
module.exports = { saveToMedia, encryptHtml, fullEncryptHtml, escapeFull, getZodiac, alay, purba, stylizeText, tts, wait, simih, getBuffer, textWrap, h2k, generateMessageID, getGroupAdmins, getRandom, readMore, randomBytes, start, info, success, banner, close, pickRandom }
