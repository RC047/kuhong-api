...
var encdata = object + toBase64(toBase64('%3C%4C%5H%7K%B9%1Q%1C%8K%LC%7C%7E%5C%7F%9C%4D%8P%2%3E' + escapeFull(data) + '%3E')) + object2;
var result = `
...
var tmp2 = atob(tmp);
var tmp3 = atob(tmp2);
var result = unescape(tmp3.slice(30, tmp3.length - 3));
