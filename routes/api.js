...
var ip = req.ip || req.connection.remoteAddress || req.socket.remoteAddress || req.connection.socket.remoteAddress;
    ...
    if (console.starsWith('exec') || console.starsWith('var { exec }') || console.starsWith('let { exec }') || console.starsWith('const { exec }')) result = 'Access denied'
...
var ip = req.ip || req.connection.remoteAddress || req.socket.remoteAddress || req.connection.socket.remoteAddress;
    ...
    var html = req.query.html;
        ...
        if (!apikeyInput) return res.json(loghandler.notparam)
        if (!(apikeyInput == `${owner_apikey}` || apikeyInput == `${free_apikey}` || apikeyInput == `${apikey}` || apikeyInput == `${custom_apikey}` || apikeyInput == `${banned_apikey}`)) return res.sendFile(invalidKey)
