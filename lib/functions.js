...
async function encryptHtml(html, level, message) {
...
var extended = await escapeFull(`eval(unescape('${escapeFull(normal)}'));`)
var advanced = await escapeFull(`eval(unescape('${escapeFull(extended)}'));`)
